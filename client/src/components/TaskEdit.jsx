...
function TaskEdit({taskIdEdit, setTaskIdEdit}){
    ...
    return(
        <div className="fixed top-0 left-0 h-screen w-screen bg-black bg-opacity-70 flex justify-center items-center">
            <div className="relative min-w-[300px] max-w-[300px] h-[500px] background-task m-4 rounded-xl p-4 flex flex-col justify-center items-center pt-2 custom-scroll shadow-2xl break-words">
