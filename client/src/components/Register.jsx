...
function Register(){
    ...
    return(
            <div className="background-main w-full h-full flex justify-center items-center relative">
                <div className="w-auto min-h-[400px] bg-white h-auto p-10 pt-14 flex flex-col justify-center items-center">
                <Formik 
                    initialValues={{
                        username: "",
                        password: "",
                ...
                >
                        ...
                        <Form className="flex flex-col justify-center items-center" onSubmit={handleSubmit}>
                            ...
                            <div className="w-full h-full flex flex-col justify-center">
                                <div className="w-full h-full flex flex-col mb-5">
                                    ...
                                    <input type="text" className="bg-white focus:placeholder:text-white text-[#a0f] focus:text-white focus:bg-gradient-to-tr from-[#00f] to-[#a0f] outline-none p-2 border border-[#a0f]" onChange={handleChange} name="username" value={values.username} />
                                </div>
                                ...
                                <div className="w-full h-full flex flex-col mb-5">
                                    ...
                                    <input type="password" className="bg-white focus:placeholder:text-white text-[#a0f] focus:text-white focus:bg-gradient-to-tr from-[#00f] to-[#a0f] outline-none p-2 border border-[#a0f]" onChange={handleChange} name="password" value={values.password} />
                                </div>
                                ...
                                <div className="w-full h-full flex flex-col mb-5">
                                    ...
                                    <input type="email" className="bg-white focus:placeholder:text-white text-[#a0f] focus:text-white focus:bg-gradient-to-tr from-[#00f] to-[#a0f] outline-none p-2 border border-[#a0f]" onChange={handleChange} name="email" value={values.email} />
                                </div>
                    ...
                    <Link className="text-[#a0f] underline font-semibold" to={"/login"}>Do you have an account?</Link>
                </div>
            </div>
        )
}
